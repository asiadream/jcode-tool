package com.asiadream.jcode.tool.xml.converter;
...
public class SqlMapSource {
    ...
    public void changeNamespace(PackageRule namespaceRule, String suffix) {
        //
