...
import com.asiadream.jcode.tool.java.sdo.ClassReference;
...
public class JavaServiceCreateTest extends BaseFileTest {
    ...
    private String createEntity() {
        ...
        return javaService.create(ReferenceSdo.create()
                .setBizName("talk")
                .addCustomContext("name", "talk"), "domain_entity", super.testDirName);
    }
    ...
    private String createEntityCase2() {
        ...
        return javaService.create(ReferenceSdo.create()
                .setBizName("talk")
                .addCustomContext("name", "joinBoard"), "domain_entity", super.testDirName);
    }
